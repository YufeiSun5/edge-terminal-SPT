    ...
    translation: {
      ...
      reportSettings: {
        ...
        planImport: {
          ...
          parse: '解析',
          confirm: '确认创建',
          openStandard: '打开检测配置 {{code}}',
          openPlan: '打开待检测计划 {{code}}',
          ...
          mapping: {
            title: 'Excel 取值配置',
            subtitle: '右侧预览上传 Excel；左侧配置项目字段、项目参数 JSON、系统变量 var_name、上下限和公式 JSON 的取值单元格。是否检测由人工确认。',
            enable: '使用单元格配置解析',
            read: '读取',
            addRow: '新增变量行',
            pickCell: '从表格选择单元格',
      ...
      detectionConfig: {
        ...
        allStandards: '全部配置',
        projectScopeOptional: '适用项目（可选）',
        itemsHint:
          '从变量中选择标准项，只维护是否检测、下限和上限。',
        advancedMode: '高级模式',
        standardInfo: '标准信息',
        advancedOptions: '高级选项',
        lowerLimit: '下限',
        upperLimit: '上限',
        addDefaultItems: '添加默认标准项',
        defaultItemsAdded: '已添加 {{count}} 个默认标准项',
        defaultItemsNoChange: '默认标准项已在列表中',
        defaultItemsMissing: '未找到这些默认变量：{{names}}',
        defaultItemsAddedWithMissing: '已添加 {{count}} 个默认标准项；未找到：{{names}}',
        copyStandard: '复制为新标准',
        copiedStandard: '已复制为新检测标准',
        copyCodeRequired: '请输入新标准编号',
        copyCodeExists: '标准编号已存在',
        copyNameRequired: '请输入新标准名称',
        enableAll: '全部启用',
        disableAll: '全部禁用',
        applyToStation: '应用到当前工位',
        processParams: '开工参数',
        processParamsHint: '单值工艺参数随本次检测冻结，不作为检测上下限项保存。',
        inletArea: '吸入口表面积',
      },
      taskFlows: {
        eyebrow: '条件事件与脚本编排',
      ...
      modelCockpit: {
        ...
        messages: {
          selectProject: '请先在左侧选择一个驾驶舱。',
          stationViewUnavailable: '工位显示配置暂不可用。',
          noMetrics: '当前工位尚未配置驾驶舱监测变量。',
          noHistory: '当前变量暂无历史趋势数据。',
          noCurrentRun: '当前工位暂无检测任务。',
          trendPlaceholder: '实时采样或开工后会在这里生成趋势。',
          sampleFallback:
      ...
      station: {
        ...
        configPreview: {
          ...
          placeholder: '选择检测配置',
          hint:
            '应用后只更新当前工位的显示上下限和开工默认配置，不会开始检测。',
          runningHint:
            '当前工位正在检测，页面继续显示本次运行冻结标准；请结束后再预加载下一次配置。',
          apply: '应用到当前工位',
          applied: '检测配置已暂存到当前工位',
          appliedTag: '已暂存',
          notApplied: '未暂存',
          runningLocked: '运行中锁定',
          metric: '检测项',
      ...
      history: {
        ...
        detail: {
          ...
          snapshot: {
            ...
            reportRequests: '报表请求',
            revisionNotice:
              '本次检测期间发生参数或检测配置变更，快照按生效时间分段展示；这是同一次检测，不代表重新检测。',
            views: {
              config: '检测配置',
              storage: '存储路由',
              reports: '报表请求',
    ...
    translation: {
      ...
      reportSettings: {
        ...
        planImport: {
          ...
          openStandard: 'Open config {{code}}',
          openPlan: 'Open pending plan {{code}}',
          ...
          mapping: {
            title: 'Excel value mapping',
            subtitle:
              'Preview the uploaded workbook on the right; configure project fields, project params JSON, system var_name, limits, and formula JSON cells on the left. Check enabled is confirmed manually.',
      ...
      detectionConfig: {
        ...
        projectScopeOptional: 'Project scope (optional)',
        itemsHint:
          'Select variables, then maintain only check status, lower limit, and upper limit.',
        advancedMode: 'Advanced mode',
        standardInfo: 'Standard info',
        advancedOptions: 'Advanced options',
        lowerLimit: 'Lower limit',
        upperLimit: 'Upper limit',
        addDefaultItems: 'Add default items',
        defaultItemsAdded: 'Added {{count}} default items',
        defaultItemsNoChange: 'Default items are already in the list',
        defaultItemsMissing: 'Default variables not found: {{names}}',
        defaultItemsAddedWithMissing: 'Added {{count}} default items; not found: {{names}}',
        copyStandard: 'Copy as new standard',
        copiedStandard: 'Copied as a new detection standard',
        copyCodeRequired: 'Enter the new standard code',
        copyCodeExists: 'Standard code already exists',
        copyNameRequired: 'Enter the new standard name',
        enableAll: 'Enable all',
        disableAll: 'Disable all',
        applyToStation: 'Apply to station',
        processParams: 'Start parameters',
        processParamsHint:
          'Single-value process parameters are frozen with this run and are not saved as detection limit items.',
        inletArea: 'Inlet area',
      },
      taskFlows: {
      ...
      modelCockpit: {
        ...
        charts: {
          ...
          realtime: 'Realtime trend',
          standardScale: 'Standard range',
          autoScale: 'Auto range',
          scaleMode: 'Axis range mode',
          toggleScale: 'Click to switch the trend axis range',
        },
        tools: {
          drag: 'Drag to rotate',
        ...
        messages: {
          selectProject: 'Select a cockpit from the sidebar.',
          stationViewUnavailable: 'Station view configuration is unavailable.',
          noMetrics: 'No cockpit monitoring variables are configured for this station.',
          noHistory: 'No historical trend data is available for these variables.',
          noCurrentRun: 'No current detection run for this station.',
          trendPlaceholder: 'Realtime samples or a running test will populate this trend.',
          sampleFallback:
            'Realtime variables are unavailable from the local backend, so sample waves are driving the callouts.',
        },
        debug: {
          eyebrow: '3D component debug',
          title: 'Model stage test page',
          stage: '3D model stage',
          items: {
            model: 'Standalone model component',
            orbit: 'Drag to rotate view',
            fluid: 'Internal flow layer reserved',
          },
        },
        fluid: {
      ...
      station: {
        ...
        configPreview: {
          title: 'Detection config preview',
          station: 'Current station',
          placeholder: 'Select detection config',
          hint:
            'Applying only updates displayed limits and the default start config for this station. It does not start a run.',
          runningHint:
            'This station is running. The page keeps showing the frozen standard for the active run; preload the next config after the run ends.',
          apply: 'Apply to station',
          applied: 'Detection config staged for this station',
          appliedTag: 'Staged',
          notApplied: 'Not staged',
          runningLocked: 'Locked while running',
          metric: 'Metric',
      ...
      history: {
        ...
        detail: {
          ...
          snapshot: {
            ...
            empty: 'No detection snapshot for this task',
            result: 'Result',
            duration: 'Duration',
            durationMs: '{{ms}} ms',
            revisionCount: 'Config revisions',
            historyRows: 'History rows',
            alarmTotal: 'Alarms',
            reportRequests: 'Report requests',
            revisionNotice:
              'Parameters or detection config changed during this task. The snapshot is split by effective time; this is the same detection run, not a retest.',
            views: {
              config: 'Test config',
            ...
            revision: 'Revision {{revision}}',
            itemCount: '{{count}} variables',
            startParams: 'Start parameters',
            noStandardItems: 'No standard items',
            variable: 'Variable',
            limits: 'Limits',
            policy: 'Policy',
            deadband: 'Deadband',
            holdMs: 'Confirm/recover ms',
            flags: 'Flags',
            checkOn: 'Check',
            checkOff: 'No check',
            alarmOn: 'Alarm',
    ...
    translation: {
      ...
      reportSettings: {
        ...
        planImport: {
          ...
          parse: '解析',
          confirm: '作成確認',
          openStandard: '検出設定 {{code}} を開く',
          openPlan: '待機計画 {{code}} を開く',
          ...
          mapping: {
            title: 'Excel 値マッピング',
            subtitle:
              '右側で Excel をプレビューし、左側でプロジェクト項目、パラメータ JSON、システム var_name、上下限、数式 JSON のセルを設定します。検出有効は手動で確認します。',
            enable: 'セルマッピングで解析',
            read: '読取',
            addRow: '変数行を追加',
            pickCell: 'シートからセルを選択',
      ...
      detectionConfig: {
        ...
        allStandards: '全設定',
        projectScopeOptional: '適用プロジェクト（任意）',
        itemsHint:
          '変数を選択し、検出するかどうか、下限、上限だけを管理します。',
        advancedMode: '詳細モード',
        standardInfo: '標準情報',
        advancedOptions: '詳細オプション',
        lowerLimit: '下限',
        upperLimit: '上限',
        addDefaultItems: '既定項目を追加',
        defaultItemsAdded: '{{count}} 件の既定項目を追加しました',
        defaultItemsNoChange: '既定項目はすでに一覧にあります',
        defaultItemsMissing: '見つからない既定変数：{{names}}',
        defaultItemsAddedWithMissing: '{{count}} 件の既定項目を追加しました。見つからない項目：{{names}}',
        copyStandard: '新しい標準としてコピー',
        copiedStandard: '新しい検出標準としてコピーしました',
        copyCodeRequired: '新しい標準番号を入力してください',
        copyCodeExists: '標準番号はすでに存在します',
        copyNameRequired: '新しい標準名を入力してください',
        enableAll: 'すべて有効',
        disableAll: 'すべて無効',
        applyToStation: '現在工位へ適用',
        processParams: '開始パラメータ',
        processParamsHint:
          '単一値の工程パラメータは今回の検出と一緒に凍結され、上下限項目として保存されません。',
        inletArea: '吸入口表面積',
      },
      taskFlows: {
      ...
      modelCockpit: {
        ...
        charts: {
          ...
          autoScale: '自動範囲',
          scaleMode: '軸範囲モード',
          toggleScale: 'クリックしてトレンド軸範囲を切り替え',
        },
        tools: {
          drag: 'ドラッグで回転',
          fluid: '内部流体効果',
        ...
        messages: {
          selectProject: '左側からコックピットを選択してください。',
          stationViewUnavailable: '工位表示設定を利用できません。',
          noMetrics: 'この工位にはコックピット監視変数が設定されていません。',
          noHistory: 'この変数には履歴トレンドデータがありません。',
          noCurrentRun: 'この工位には現在の検査タスクがありません。',
          trendPlaceholder: 'リアルタイムサンプルまたは検査開始後にトレンドを表示します。',
          sampleFallback:
            'ローカル後端のリアルタイム変数が利用できないため、サンプル波形でポップアップを駆動しています。',
        },
        debug: {
          eyebrow: '3D コンポーネント調整',
          title: 'モデルステージ試験ページ',
          stage: '3D モデルステージ',
          items: {
            model: '独立モデルコンポーネント',
      ...
      station: {
        ...
        configPreview: {
          ...
          placeholder: '試験設定を選択',
          hint:
            '適用しても表示上限/下限と開始時の既定設定だけを更新します。試験は開始しません。',
          runningHint:
            'この工位は試験中です。画面は実行中タスクの凍結標準を表示します。終了後に次回設定をプリロードしてください。',
          apply: 'この工位に適用',
          applied: '試験設定をこの工位に一時適用しました',
          appliedTag: '一時適用済み',
          notApplied: '未適用',
          runningLocked: '実行中ロック',
          metric: '検査項目',
          range: '表示上限/下限',
          status: '状態',
          checkOn: '検査',
      ...
      history: {
        ...
        detail: {
          ...
          snapshot: {
            title: '検査スナップショット',
            empty: 'このタスクには検査スナップショットがありません',
            result: '検査結果',
            duration: '検査時間',
            durationMs: '{{ms}} ms',
            revisionCount: '設定バージョン',
            historyRows: '履歴行数',
            alarmTotal: '警報数',
            reportRequests: '帳票要求',
            revisionNotice:
              'この検査中にパラメータまたは検査設定が変更されました。スナップショットは有効時刻ごとに分けて表示します。これは同一検査であり、再検査ではありません。',
            views: {
              config: '検査設定',
              storage: '保存ルート',
              reports: '帳票要求',
