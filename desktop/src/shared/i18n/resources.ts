export const resources = {
  zh: {
    translation: {
      ...
      reports: {
        ...
        run: '检测记录',
        updatedAt: '更新：{{value}}',
        bindings: '字段映射 {{mapped}}/{{total}}',
        cell: '单元格',
        taskTrend: '任务线图',
        loadChart: '加载线图到 Excel',
        chartLoaded: '任务线图已加载到报表样例区',
        chartLoadedState: '已加载线图',
        loaded: '已加载',
        mockOnly: '模拟数据',
        entryTitle: '报表录入画布',
        viewTitle: '报表查看画布',
        ...
        save: '保存',
        export: '导出',
        staticHint: '报表接口未接入，当前导出仅作为画面占位。',
      },
      status: {
        online: '在线',
        offline: '离线',
  ...
  en: {
    translation: {
      ...
      reports: {
        eyebrow: 'Template entry and report preview',
        title: 'Reports',
        entry: 'Entry',
        view: 'View',
        templatePanel: 'Template and fields',
        historyPanel: 'Historical reports',
        template: 'Report template',
        run: 'Detection run',
        updatedAt: 'Updated: {{value}}',
        bindings: 'Field mapping {{mapped}}/{{total}}',
        cell: 'Cell',
        taskTrend: 'Task line chart',
        loadChart: 'Load chart into Excel',
        chartLoaded: 'Task chart data has been loaded into the sample report area.',
        chartLoadedState: 'Chart loaded',
        loaded: 'Loaded',
        mockOnly: 'Mock data',
        entryTitle: 'Report entry canvas',
        viewTitle: 'Report preview canvas',
        import: 'Import',
        save: 'Save',
        export: 'Export',
        staticHint: 'Report APIs are not connected yet. Export is a screen placeholder for now.',
      },
      status: {
        online: 'Online',
        offline: 'Offline',
      ...
      station: {
        ...
        run: {
          ...
          reportVariables: 'Report variables for this run',
          reportExt1: 'Report note 1',
          reportExt2: 'Report note 2',
          reportExt3: 'Report note 3',
  ...
  ja: {
    translation: {
      ...
      reports: {
        eyebrow: 'テンプレート入力と履歴表示',
        title: '帳票',
        entry: '帳票入力',
        view: '帳票表示',
        templatePanel: 'テンプレートと項目',
        historyPanel: '履歴帳票',
        template: '帳票テンプレート',
        run: '検出記録',
        updatedAt: '更新：{{value}}',
        bindings: '項目マッピング {{mapped}}/{{total}}',
        cell: 'セル',
        taskTrend: 'タスク折れ線グラフ',
        loadChart: 'グラフを Excel に読込',
        chartLoaded: 'タスクグラフデータを帳票サンプル領域へ読み込みました。',
        chartLoadedState: 'グラフ読込済み',
        loaded: '読込済み',
        mockOnly: 'モックデータ',
        entryTitle: '帳票入力キャンバス',
        viewTitle: '帳票表示キャンバス',
        import: 'インポート',
        save: '保存',
        export: 'エクスポート',
        staticHint: '帳票 API は未接続です。現在のエクスポートは画面プレースホルダーです。',
      },
      status: {
        online: 'オンライン',
        offline: 'オフライン',
