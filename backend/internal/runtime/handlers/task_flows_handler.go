	...
	c.JSON(http.StatusOK, []gin.H{
		{
			...
			"params_schema": gin.H{
				...
				"factory_no":            gin.H{"type": "string", "required": false, "source": []string{"literal", "trigger_param", "context"}},
				"customer_name":         gin.H{"type": "string", "required": false, "source": []string{"literal", "trigger_param", "context"}},
				"device_model":          gin.H{"type": "string", "required": false, "source": []string{"literal", "trigger_param", "context"}},
				...
				"config_enabled":        gin.H{"type": "boolean", "required": false, "source": []string{"literal", "trigger_param", "context"}},
				"config_code":           gin.H{"type": "string", "required": false, "source": []string{"literal", "trigger_param", "context"}},
				"config_name":           gin.H{"type": "string", "required": false, "source": []string{"literal", "trigger_param", "context"}},
				"config_version":        gin.H{"type": "number", "required": false, "source": []string{"literal", "trigger_param", "context"}},
				"config_hash":           gin.H{"type": "string", "required": false, "source": []string{"literal", "trigger_param", "context"}},
			...
			"steps": []gin.H{
				...
				},
				{
					...
					"params": gin.H{
						...
						"factory_no":            gin.H{"source": "trigger_param", "key": "factory_no", "optional": true},
						"customer_name":         gin.H{"source": "trigger_param", "key": "customer_name", "optional": true},
						"device_model":          gin.H{"source": "trigger_param", "key": "device_model", "optional": true},
						...
						"config_enabled":        gin.H{"source": "trigger_param", "key": "config_enabled", "optional": true},
						"config_code":           gin.H{"source": "trigger_param", "key": "config_code", "optional": true},
						"config_name":           gin.H{"source": "trigger_param", "key": "config_name", "optional": true},
						"config_version":        gin.H{"source": "trigger_param", "key": "config_version", "optional": true},
						"config_hash":           gin.H{"source": "trigger_param", "key": "config_hash", "optional": true},
						"custom_items":          gin.H{"source": "trigger_param", "key": "custom_items", "optional": true},
						"runtime_draft":         gin.H{"source": "trigger_param", "key": "runtime_draft", "optional": true},
