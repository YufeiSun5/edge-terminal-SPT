...
func TestTableNames(t *testing.T) {
	names := map[string]string{
		...
		StationViewTemplate{}.TableName():       "sys_station_view_templates",
		StationViewRegion{}.TableName():         "sys_station_view_regions",
		StationViewItem{}.TableName():           "sys_station_view_items",
		StationViewAssignment{}.TableName():     "sys_station_view_assignments",
		...
		EdgeControlCommand{}.TableName():        "edge_control_commands",
